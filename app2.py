...
ANALYSIS
The model confidence exceeded the routing threshold of 90%.
External retrieval and LLM reasoning were skipped.
...
def llm_judge(state: NewsState):
    ...
    prompt = f"""
You are a professional news fact-checking AI.
...
builder.add_conditional_edges(
    ...
    confidence_router,
    {
        "high_confidence": "fast_verdict",
        "low_confidence": "retrieval_node"
    }
)
...
if __name__ == "__main__":
    ...
    article = """
    Scientists claim a newly discovered vaccine
    completely eliminates all forms of cancer
    within 24 hours.
    """
